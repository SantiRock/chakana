export const fragmentCode = `
    ...
    void main(void) {
        ...
        // Chakana
        highp vec3 chakana = mix(square, vec3(1.), recth);
        chakana = mix(chakana, vec3(1), rectv);
        chakana += circle;
        ...
        // Chakana
        highp vec3 chakana2 = mix(square1, vec3(1.), recth1);
        chakana2 = mix(chakana2, vec3(1), rectv1);
        chakana2 += circle1;

        // COLOR

        highp vec3 color = vec3(0.);
        color = chakana - chakana2;



        color *= vec3(0.6, 0.7, 0.90);
